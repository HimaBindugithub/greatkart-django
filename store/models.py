...
class Product(models.Model):
    ...
    category        = models.ForeignKey(Category, on_delete=models.CASCADE) #on_delete is used bcoz when we delete the category then it deletes the contire product details
