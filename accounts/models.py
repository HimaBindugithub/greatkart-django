...
class MyAccountManager(BaseUserManager):
    def create_user(self,first_name,last_name,username,email,password=None):
        ...
        user=self.model(
          ...
          #here normalize_email is used bcoz,if we enter capital letters in email it makes it as small letters 
          username=username,
...
class Account(AbstractBaseUser):
    ...
    #required(these six fields are mandatory when creating custom user model)
